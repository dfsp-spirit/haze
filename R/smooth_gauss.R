...
# This function is currently disabled as the Rvcg::vcgSmoothPVD function can only be found
# in my own branch of Rvcg and it still needs some work and proper tests.
